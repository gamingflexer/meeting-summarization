...
if DEBUG == False:
    ...
    whisper2 = pipeline('automatic-speech-recognition', model = 'asach/whisper_ami_finetuned-added', chunk_length_s=30, device=0) #'/home/student/Documents/dp/v1.1/whisper_ami
